...

{
  ...
  assert.equal(OVERVIEW_ROWS.find(row => row.groupLabel === 'Weekday Service').dividerBefore, true)
  assert.equal(OVERVIEW_ROWS.find(row => row.groupLabel === 'Sunday Service').dividerBefore, true)
